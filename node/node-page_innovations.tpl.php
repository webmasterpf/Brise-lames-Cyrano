...
*/?>
<!--______________NODE TPL POUR PAGE.TPL INNOVATIONS ________________ -->
 ...
 <div class="node-inner">
        ...
        <div id="colonne-1" class="col1_layout_225_700">
            ...
            <?php endif; ?>
             ...
             <?php if ($node->field_fiche_action_innovation[0]['view'] OR 
                      $node->field_fichier_joint_innovation[0]['view']): ?>
            <div id="docs-joints-vdl">
                <h3>Utile</h3>
                
            <div id="fiche-action-vdl">
                    <?php  print $node->field_fiche_action_innovation[0]['view']  ?>
            </div>
