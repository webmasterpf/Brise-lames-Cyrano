...
$args_fl3 = $view->set_arguments(array(14));
...
if (!empty($view->result)) {
  ...
  $output = '<div id="restauration" class="bloc-pole"><h3 class="CLASS_NAME">'.$view->get_title().'</h3>' .$view->preview($viewdisplay_fl3,$args_fl3).'</div>';
...
elseif (empty($view->result)) {
    //Formatage du texte vide,ajout du titre de la vue
     $outputEmpty = '<div id="restauration" class="bloc-pole"><h3 class="CLASS_NAME">'.$view->get_title().'</h3>' .$emptyText.'<br>'.$emptyTextVue.'</div>';
